                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header bg-info text-light">
                      <h3 class="card-title"> Closed Loans</h3>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table text-center">
                          ...
                          <?php
                            ...
                            $result = mysqli_query($connectDB,"SELECT * FROM newloan WHERE isActive = false ORDER BY sNo DESC");
                            $i = 0;
                            while($row = mysqli_fetch_array($result))
                            {
                                ...
                                echo "<td><i class = \"fas fa-redo text-primary\"   onclick=\"closeLoan('".$row['loanID']."')\" style = \"cursor:pointer\" data-toggle = \"modal\" data-target = \"#closeModal\" ></td>";
                                echo "</tbody>";
                            }
                        ?>
                        </table>
                    ...
                    <div class="modal fade" id="closeModal" tabindex="-1" role="dialog" aria-labelledby="closeModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                            <div class="modal-header bg-info text-light">
                                <h3 class="modal-title" id="closeModalLabel">Account Re-Open</h3>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true" class="text-light">&times;</span>
                                </button>
                            </div>
