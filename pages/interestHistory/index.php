...
<head>
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        var id = $('#loanID').val();
        var test = $('#test').val();
        $('#bodyHandler').load('getHistory.php?id=' + id + '&test='+ test);
            ...
            <div class="card">
                <div class="card-header bg-info text-light">
                    <div class="card-title">
                        ...
                        <div class="form-inline align-items-center" style="float: right;">
                          ...
                          <button type="button" class="btn mb-2"  onclick="searchByID()">Search</button>
                        </div>
                    </div>
                </div>
                <div class="card-body" id="searchBody">
                    <div class="row text-center">
                        <div class="col-md-12">
                        <h1><i class="fas fa-history text-info payIcon"></i></h1>
                        </div>
                        <div class="col-md-12">
                            <p>Please, Enter your Loan ID and click 'Search' to get loan History.</p>
                        </div>
                    </div>
                </div>
